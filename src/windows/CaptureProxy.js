...
const MediaFile = require('cordova-plugin-ns0m-media-capture.MediaFile');
const CaptureError = require('cordova-plugin-ns0m-media-capture.CaptureError');
const CaptureAudioOptions = require('cordova-plugin-ns0m-media-capture.CaptureAudioOptions');
const CaptureVideoOptions = require('cordova-plugin-ns0m-media-capture.CaptureVideoOptions');
const MediaFileData = require('cordova-plugin-ns0m-media-capture.MediaFileData');
